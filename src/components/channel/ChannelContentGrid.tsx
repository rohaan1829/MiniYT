            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {videos.map((video) => (
                    <Link key={video.id} href={`/watch/${video.id}`}>
                        <div className="group relative aspect-square rounded-2xl overflow-hidden bg-secondary cursor-pointer">
                            <img
                            ...
                            {/* Views badge */}
                            <div className="absolute bottom-2 left-2 px-2 py-0.5 bg-black/80 text-white text-xs font-medium rounded flex items-center gap-1">
